module.exports = function (app, pool) {
    app.post('/api/resetpassword', (request, response) => {
        ...
        const checkForUserId = async () => {
            var sql = "SELECT id, username, email FROM users WHERE username = $1 OR email = $1"
        ...
        const generateResetCode = async (rows) => {
            ...
            while (true) {
                ...
                var sql = 'SELECT * FROM password_resets WHERE reset_code = $1;'
            ...
            try {
                var sql = `INSERT INTO password_resets (user_id, reset_code, expire_time)
        ...
        const sendResetMail = async (paramsForMail) => {
            var mailOptions = {
                ...
                html: `<h1>Hello!</h1><p>Click the link below to reset your password.</p>
    ...
    app.post('/api/setnewpassword', async (request, response) => {
        ...
        if (password !== confirmPassword) {
            ...
            var sql = `SELECT * FROM password_resets
